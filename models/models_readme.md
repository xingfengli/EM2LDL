...
- **Org.zip on Experiment 1: Overall Baseline Performance on the EM²LDL**  
  A speaker-independent split of the full corpus into training/validation/test partitions at a 70/10/20 ratio (7:1:2) by speaker ID. No speaker overlap occurs across partitions. For details, please check models/train_val_test/*.csv files.
